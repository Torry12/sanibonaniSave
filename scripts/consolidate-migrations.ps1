# PowerShell script to automate SQL consolidation for SanibonaniSave
# This script reads all migration files and inlines their content into the consolidated SQL files.
# Usage: ./scripts/consolidate-migrations.ps1

param(
    [string]$MigrationsDir = "C:/Users/CRISS/AndroidStudioProjects/SanibonaniSave_Full/supabase/migrations",
    [string]$ConsolidatedTemplate = "C:/Users/CRISS/AndroidStudioProjects/SanibonaniSave_Full/consolidated/CONSOLIDATED_FOR_SUPABASE.sql",
    [string]$ConsolidatedOut = "C:/Users/CRISS/AndroidStudioProjects/SanibonaniSave_Full/consolidated/CONSOLIDATED_FOR_SUPABASE.inlined.sql"
)
...
function Inline-Migrations {
    ...
    # Map migration file markers to actual files (ordered)
    $migrationFiles = @(
