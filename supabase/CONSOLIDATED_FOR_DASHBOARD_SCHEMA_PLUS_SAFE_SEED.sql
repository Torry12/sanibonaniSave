...
-- Non-destructive: creates schema objects IF NOT EXISTS and then runs the SAFE seed.
-- Purpose: paste into Supabase SQL editor to ensure schema exists (non-destructive) and load SAFE seed only.
-- IMPORTANT: This will NOT DROP or recreate the public schema. It attempts to be idempotent.
